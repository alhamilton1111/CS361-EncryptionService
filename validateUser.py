...
import os
##################################################
# User ID/Password Validation Service (Encrypted)
# Andrea Hamilton
# May 9, 2022
##################################################
...
# It handles UserID and PassWord as 2 separate strings
###########################################################
...
###########################################################
# function to add user to valid user list:
# "validUsers.txt" in an Encrypted form
###########################################################
...
###########################################################
# Main validate user function.
# Runs All data in an Encrypted state
###########################################################
